...
public class MethodNotFoundException extends MappingException {
    ...
    /**
     * Construct a new <code>MethodNotFoundException</code> instance.
     *
     ...
     */
    public MethodNotFoundException(final Throwable throwable) {
        super(throwable);
    }
     ...
     * @param throwable the root cause of the exception
     */
    public MethodNotFoundException(final String message, final Throwable throwable) {
