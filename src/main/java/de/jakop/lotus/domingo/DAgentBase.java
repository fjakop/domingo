 ...
 *
 * @deprecated use new class {@link de.jakop.lotus.domingo.notes.DAgentBase} instead
 *
...
public abstract class DAgentBase extends AgentBase {
    ...
    public final void NotesMain() {
        ...
        try {
            ...
            factory = DNotesFactory.getInstance("de.jakop.lotus.domingo.proxy.NotesProxyFactory", monitor);
    ...
    public final Session getSession() {
        if (isSessionProtected) {
            throw new DNotesRuntimeException(RESOURCES.getString("agent.illegal.access"));
        } else {
