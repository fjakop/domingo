...
public class DNotesRuntimeException extends RuntimeException implements CascadingThrowable {
    ...
    private static final long serialVersionUID = 3546925766437648438L;

    /** detail error of the exception. */
    private final Throwable fCause;

    /**
     * Construct a new <code>DNotesRuntimeException</code> instance.
     *
     * @param message The detail message for this exception.
     */
    public DNotesRuntimeException(final String message) {
        super(message);
        fCause = null;
    }
     ...
     */
    public DNotesRuntimeException(final Throwable cause) {
        super();
        fCause = cause;
    }
     ...
     *          cause is nonexistent or unknown.
     */
    public DNotesRuntimeException(final String message, final Throwable cause) {
        super(message);
        fCause = cause;
    }
