...
public class NotesHttpException extends DNotesException {
    ...
    /**
     * Construct a new <code>NotesHttpException</code> instance.
     *
     * @param message The detail message for this exception.
     */
    public NotesHttpException(final String message) {
        super(message);
    }
     ...
     */
    public NotesHttpException(final Throwable throwable) {
        super(throwable);
    }
    /**
     * Construct a new <code>NotesHttpException</code> instance.
     ...
     * @param throwable the root cause of the exception
     */
    public NotesHttpException(final String message, final Throwable throwable) {
