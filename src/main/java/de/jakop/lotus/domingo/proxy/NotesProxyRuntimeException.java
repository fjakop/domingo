...
public final class NotesProxyRuntimeException extends DNotesRuntimeException {
    ...
    /**
     * Construct a new <code>NotesProxyRuntimeException</code> instance.
     *
     * @param message The detail message for this exception.
     */
    public NotesProxyRuntimeException(final String message) {
        super(message);
    }
     ...
     */
    public NotesProxyRuntimeException(final DominoException throwable) {
        super(throwable);
    }
     ...
     * @param throwable the root cause of the exception
     */
    public NotesProxyRuntimeException(final String message, final Throwable throwable) {
