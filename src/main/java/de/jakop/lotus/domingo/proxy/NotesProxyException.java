...
public class NotesProxyException extends DNotesException {
    ...
    /**
     * Construct a new <code>NotesProxyException</code> instance.
     *
     * @param message The detail message for this exception.
     */
    public NotesProxyException(final String message) {
        super(message);
    }
     ...
     */
    public NotesProxyException(final Throwable throwable) {
        super(throwable);
    }
    /**
     * Construct a new <code>NotesProxyException</code> instance.
     ...
     */
    public NotesProxyException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
