...
public class NotesServiceRuntimeException extends DNotesRuntimeException {
    ...
    /**
     * Construct a new <code>NotesServiceRuntimeException</code> instance.
     *
     * @param message The detail message for this exception.
     */
    public NotesServiceRuntimeException(final String message) {
        super(message);
    }
     ...
     */
    public NotesServiceRuntimeException(final Throwable throwable) {
        super(throwable);
    }
     ...
     * @param throwable the root cause of the exception
     */
    public NotesServiceRuntimeException(final String message, final Throwable throwable) {
