 ...
 * properties of the view column from which they where created. <p>If digest
 ...
 * the concrete mapper, but it is recommended to use this base class.</p>
 *
...
public abstract class BaseInstance {
     ...
     * Constructor.
     *
     * @param instance another instance for copying data from.
     */
    public BaseInstance(final BaseInstance instance) {
        // Don't copy unid!
    }
